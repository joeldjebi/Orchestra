...
@section('title', 'Ajouter une Valeur - Orchestra Admin')

@section('page-title', 'Ajouter une Valeur')
            ...
            <div class="details-section">
                ...
                <div id="details-container">
                    <div class="detail-input">
                        ...
                        <button type="button" class="remove-detail-btn" onclick="removeDetail(this)" style="display: none;">
