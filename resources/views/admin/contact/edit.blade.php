...
@section('title', 'Modifier les Informations de Contact - Orchestra Admin')

@section('page-title', 'Modifier les Informations de Contact')
        ...
        <form action="{{ route('admin.contact.update', $contact) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="hours-section">
                ...
                <div id="hours-container">
                    ...
                    <div class="hours-input">
                        <input type="text" name="office_hours[{{ $day }}]" placeholder="Jour" value="{{ $day }}">
                        <input type="text" name="office_hours[{{ $day }}]" placeholder="Horaires" value="{{ $hours }}">
                    </div>
                    @endforeach
                </div>
                @error('office_hours')
            ...
            <div class="form-group">
                ...
                <div class="current-image">
                    <img src="{{ asset($contact->image) }}" alt="{{ $contact->title }}">
                </div>
            </div>
            @endif
