...
@section('title', 'Ajouter un Article - Orchestra Admin')
        ...
        <form action="{{ route('admin.blog.store') }}" method="POST">
            ...
            <div class="content-section">
                ...
                <div class="paragraph-group">
                    ...
                    >{{ old('content.paragraph1') }}</textarea>
                ...
                <div class="paragraph-group">
                    ...
                    >{{ old('content.paragraph2') }}</textarea>
                ...
                <div class="paragraph-group">
                    ...
                    >{{ old('content.paragraph3') }}</textarea>
                ...
                <div class="paragraph-group">
                    ...
                    >{{ old('content.paragraph4') }}</textarea>
                ...
                <div class="paragraph-group">
                    ...
                    >{{ old('content.paragraph5') }}</textarea>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <div class="layout-options">
                        <label class="layout-option {{ old('layout', 'left') === 'left' ? 'selected' : '' }}">
                            <input type="radio" name="layout" value="left" {{ old('layout', 'left') === 'left' ? 'checked' : '' }}>
                            <div>
                        ...
                        <label class="layout-option {{ old('layout') === 'right' ? 'selected' : '' }}">
                            <input type="radio" name="layout" value="right" {{ old('layout') === 'right' ? 'checked' : '' }}>
                            <div>
