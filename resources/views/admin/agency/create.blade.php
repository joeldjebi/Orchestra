...
@section('title', 'Ajouter une Agence - Orchestra Admin')

@section('page-title', 'Ajouter une Agence')
                ...
                <div id="services-container">
                    ...
                    @else
                        <div class="service-input">
                            ...
                            <button type="button" class="remove-service-btn" onclick="removeService(this)" style="display: none;">
                                <i class="fas fa-trash"></i>
                            </button>
                        </div>
                    @endif
