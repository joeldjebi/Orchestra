...
@section('title', 'Modifier le Membre - Orchestra Admin')
    ...
    <div class="form-card">
        <form action="{{ route('admin.leadership.update', $leadership) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input
                        ...
                        value="{{ old('name', $leadership->name) }}"
                        required
            ...
            <div class="form-group">
                ...
                >{{ old('description', $leadership->description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <div class="file-input">
                    ...
                    <label for="image" class="file-input-label">
                        ...
                        <div>
                            <div style="font-weight: 600; margin-bottom: 5px;">Cliquez pour changer la photo</div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input
                        ...
                        value="{{ old('order', $leadership->order) }}"
                        min="0"
                        placeholder="0"
                    >
